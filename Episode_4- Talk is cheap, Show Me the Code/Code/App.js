...
//*Structure of the Food ordering App.
/*
 * Header
 *  -Logo
 *  -Nav items
  ...
  return (
    <div className="Res-Card">
      <div className="Res-Image-Container">
        <img
          className="Res-Image"
          src={"https://media-assets.swiggy.com/swiggy/" + cloudinaryImageId}
          alt="res-logo-image"
        />
      </div>
...
//* not using keys (not acceptable) <<<<<< unique keys as Index  <<<<<<<< unique id for keys (best practice)
  ...
  return (
    <div className="Header">
      <div className="LogoContainer">
        <img
          className="Logo"
          src="https://i.pinimg.com/564x/b1/fc/bb/b1fcbbfd4fb8116c714ef352bb39bbaf.jpg"
          alt="logo"
        />
      </div>
